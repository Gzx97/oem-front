  ...
  render() {
    ...
    return (
      <div id="Jianshang">
        <AccountHeader />
        {/* 头部卡片 加浮动卡片 */}
        <div className="it_title">泰迪熊新年活动</div>
        ...
        <div className="cp_top_box">
          ...
          <div className="cp_right">
            <p>
            泰迪熊新年送好礼，参与获得即有机会获得限量版数字藏品及权益，快来参与吧！
            </p>
            <span
              onClick={() => {
          ...
          <ul>
            <li>
              ...
              <div className="li_info">
                <p>
                收集全部{(tiaozhan.cimu && tiaozhan.cimu.aim) || 0}
                个泰迪熊系列数字藏品即可免费获得限量版泰迪熊珍藏数字藏品奖励 <br />
